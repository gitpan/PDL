...
#ifdef DEC
static short DZ1[] = {0041152,0164532,0006114,0010540};
static short DZ2[] = {0041504,0157663,0001625,0020621};
#define Z1 (*(double *)DZ1)
#define Z2 (*(double *)DZ2)
#endif

#ifdef IBMPC
static short DZ1[] = {0x822c,0x4189,0x5d2b,0x402d};
static short DZ2[] = {0xa432,0x6072,0x9bf6,0x4048};
#define Z1 (*(double *)DZ1)
#define Z2 (*(double *)DZ2)
#endif

#ifdef MIEEE
static short DZ1[] = {0x402d,0x5d2b,0x4189,0x822c};
static short DZ2[] = {0x4048,0x9bf6,0x6072,0xa432};
#define Z1 (*(double *)DZ1)
#define Z2 (*(double *)DZ2)
#endif
