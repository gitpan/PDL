...
=head2 Complete List of Exported Functions
...
* = indicates C<inplace()> safe & useful with this function

=head2 Complete List of PDL methods

For convenience (the ->meth syntax looks more appropriate) some
pdl routines are defined as methods:

$pdl->flush    -  Update C cache from perl values
