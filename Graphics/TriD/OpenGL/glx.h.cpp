...
Start of /usr/include/GL/glx.h (23Cnba1nbf31)....
FENCE (11HdyTbIVg6s): Ignore stuff till the next fence (#include <X11/Xlib.h>)
...
FENCE (23Cnba1nbf31): Stop ignoring stuff


FENCE (11HdyTbIVg6s): Ignore stuff till the next fence (#include <X11/Xutil.h>)
typedef struct {
     long flags;
 int x, y;
 int width, height;
...
FENCE (11HdyTbIVg6s): Ignore stuff till the next fence (#include <GL/gl.h>)
...
FENCE (11HdyTbIVg6s): Ignore stuff till the next fence (#include <GL/glxext.h>)
